...
class MetaPathGenerator:
    ...
    #             outfile.write(outline + "\n")
    #     outfile.close()
    # def read_utlpcdata(self, dirpath):
    #     self.id_poi.clear()
    #     self.id_user.clear()
    #     self.id_tl.clear()
    #     self.id_cate.clear()
    ...
    #                 self.id_cate[toks[0]] = toks[0]
    #
    #     with open(dirpath + "\\user_tl_poi_cate.txt",'r', encoding='ISO-8859-1') as pafile:
    #         for line in pafile:
    #             toks = line.strip().split("\t")
    #             if len(toks) == 4:
    #                 u, tl, p ,c = toks[0], toks[1], toks[2], toks[3]  #tokes[2]是类别名称，toks[3]是类别id
    #                 #u:'37',p:'4e3e097552b1a04aff2139ff'
    #                 if u not in self.user_tllist:
    #                     self.user_tllist[u] = []
    #                 self.user_tllist[u].append(tl)
    ...
    #                     self.cate_poilist[c] = []
    #                 self.cate_poilist[c].append(p)
    # def generate_random_utlpcptlu(self, outfilename, numwalks, walklength):
    #     outfile = open(outfilename, 'w', encoding="ISO-8859-1")
    #     for user in self.user_tllist:
    #         user0 = user
    #         #随机初始tl0
    ...
    #
    #                 cate = self.poi_catelist[poi]
    #                 outline += " " + cate  # 路径U TL P C
    #
    #                 pois = self.cate_poilist[cate]  # 类别对应的地点
    #                 numc = len(pois)  # numc代表类别c对应的poi个数
    #                 poiid = random.randrange(numc)
    #                 poi = pois[poiid]
    #                 outline += " " + self.id_poi[poi]  # 路径U TL P C P
    #
    #                 tls = self.poi_tllist[poi]
    #                 numtl = len(tls)
    #                 while (1):
    ...
    #                 userid = random.randrange(numu)
    #                 user = users[userid]
    #                 outline += " " + self.id_user[user]  #路径U TL P C P TL U
    #             outfile.write(outline + "\n")
    #     outfile.close()
...
# utlpc_dirpath = ".\\data\\utlpc\\input"
# utlpc_outfilename = ".\\data\\utlpc\\vector\\random_walks.txt"
...
if __name__ == "__main__":
    ...
    # mpg.read_utlpcdata(utlpc_dirpath)
    # mpg.generate_random_utlpcptlu(utlpc_outfilename, numwalks, walklength)
###########################################################################################################################
